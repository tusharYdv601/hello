<h1>2386 - Min Max Game</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/min-max-game/">min-max-game</a></h2><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code> whose length is a power of <code>2</code>.</p>
