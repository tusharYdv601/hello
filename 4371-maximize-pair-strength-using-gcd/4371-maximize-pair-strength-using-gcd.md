<h1>4371 - Maximize Pair Strength Using GCD</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/maximize-pair-strength-using-gcd/">maximize-pair-strength-using-gcd</a></h2><p>You are given an integer array <code>nums</code>.</p>
