<h1>4351 - Minimum Total Cost to Process All Elements</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-total-cost-to-process-all-elements/">minimum-total-cost-to-process-all-elements</a></h2><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>
