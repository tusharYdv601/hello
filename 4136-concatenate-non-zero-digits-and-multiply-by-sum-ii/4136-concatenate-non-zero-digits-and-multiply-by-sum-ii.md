<h1>4136 - Concatenate Non-Zero Digits and Multiply by Sum II</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/concatenate-non-zero-digits-and-multiply-by-sum-ii/">concatenate-non-zero-digits-and-multiply-by-sum-ii</a></h2><p>You are given a string <code>s</code> of length <code>m</code> consisting of digits. You are also given a 2D integer array <code>queries</code>, where <code>queries[i] = [l<sub>i</sub>, r<sub>i</sub>]</code>.</p>
