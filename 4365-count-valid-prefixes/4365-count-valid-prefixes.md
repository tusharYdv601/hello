<h1>4365 - Count Valid Prefixes</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/count-valid-prefixes/">count-valid-prefixes</a></h2><p>You are given a <span data-keyword="binary-string">binary string</span> <code>s</code>.</p>
